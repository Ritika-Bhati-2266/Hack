  ...
  return (
    <div className="space-y-4 min-w-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* TODAY */}
        <div className="rounded-[24px] border border-white/15 bg-surface p-4 sm:p-6 relative overflow-hidden min-w-0 card-hover">
          <div className="absolute top-0 left-0 right-0 h-1 bg-emerald-500/70" />
          <div className="flex items-center justify-between mb-5">
            <span className="text-[10px] font-black tracking-[0.18em] text-slate-500 bg-white/5 px-2.5 py-1 rounded-full border border-white/15">STATE TODAY</span>
          ...
          <div className="space-y-3">
            <div className="rounded-2xl bg-well/60 border border-white/15 p-4">
            ...
            <div className="rounded-2xl bg-well/60 border border-white/15 p-4 flex items-center justify-between">
        ...
        <div className={`rounded-[24px] border bg-surface p-4 sm:p-6 relative overflow-hidden min-w-0 card-hover ${border}`}>
          ...
          <div className="flex items-center justify-between mb-5">
            <span className="text-[10px] font-black tracking-[0.18em] text-slate-500 bg-white/5 px-2.5 py-1 rounded-full border border-white/15">STATE SIMULATED</span>
